...
void main(void)
{
	// Triangle englobant la fenetre entiere ???
...
bool intersect( const Triangle triangle, const vec3 o, const vec3 d,
				const float tmax, out float rt, out float ru, out float rv ) {
